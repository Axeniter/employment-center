...
public partial class VacancyDetailPage : ContentPage
{
    ...
    protected override async void OnAppearing()
    {
        ...
        var viewModel = IPlatformApplication.Current!.Services.GetService<VacancyDetailViewModel>();
        ...
        if (viewModel != null)
        {
            ...
            if (route.Contains("vacancydetail") && int.TryParse(GetQueryParam(route, "id"), out int vacancyId))
            {
